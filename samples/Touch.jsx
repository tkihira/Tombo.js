	...
	static function main(args: string[]): void {
		...
		logoImg.onload = (e) -> {
			...
			buttonImg.onload = (e) -> {
				...
				var buttonGroup1 = new DisplayGroup(30, -100);
				var buttonGroup2 = new DisplayGroup(-30, 200);
				buttonGroup2.setScale(2, 2);

				var buttonNode = new DisplayNode(buttonImageShape, 256, 290, 0.5, 0.5);
				buttonNode.setTouchable(true);
				layer.root.appendChild(buttonGroup1);
				buttonGroup1.appendChild(buttonGroup2);
				buttonGroup2.appendChild(buttonNode);
