...
//		}
	...
	function setTransform(transform: Transform, nodeId: number, stream: Stream = null): void {
		...
		if(stream) {
			...
			stream.sendSetTransform(this._id, nodeId, matrix[0] * this.layout.scale, matrix[1] * this.layout.scale, matrix[2] * this.layout.scale, matrix[3] * this.layout.scale, matrix[4] * this.layout.scale, matrix[5] * this.layout.scale);
		} else {
